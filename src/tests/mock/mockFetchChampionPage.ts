export const mockFetchChampionPage = {
  type: 'champion',
      ...
      spells: [
        {
          ...
          leveltip: {
            label: ['Tempo de Recarga', 'Dano', 'Multiplicador de DdA total'],
            effect: [
              '{{ cooldown }} -> {{ cooldownNL }}',
        ...
        },
        {
          ...
          leveltip: {
            label: ['Tempo de Recarga', 'Dano', 'Redução de velocidade'],
            effect: [
              '{{ cooldown }} -> {{ cooldownNL }}',
        ...
        },
        {
          ...
          tooltip:
            '<spellPassive>Passivo:</spellPassive> Aatrox se cura em <lifeSteal>{{ espellvamp }}%</lifeSteal> do dano causado a Campeões. O valor aumenta para <lifeSteal>{{ espellvampempowered }}%</lifeSteal> durante <keywordMajor>Aniquilador de Mundos</keywordMajor>.<br /><br /><spellActive>Ativo:</spellActive> Aatrox avança. Ele pode usar essa Habilidade durante as animações das outras Habilidades.{{ spellmodifierdescriptionappend }}',
          leveltip: {
            label: [
              'Tempo de Recarga',
              'Porcentagem de cura',
              'Porcentagem de cura durante Aniquilador de Mundos',
            ],
            effect: [
              '{{ cooldown }} -> {{ cooldownNL }}',
